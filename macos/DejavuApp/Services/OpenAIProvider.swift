...
struct OpenAIProvider: LanguageModelProvider {
    ...
    suggestedCollection: выбери тему именно original по смыслу: dates (свидания и романтические отношения),
    fashion (одежда и стиль), travel (поездки, транспорт, отель), messages (переписка и договорённости).
    Если явной связи нет или темы равнозначны — null. Не выбирай тему по случайному примеру.
